...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Image upload doesn't fully work
...
function showMessage(msg, type) {
  ...
  if (type === "success") {
    msgDiv.style.cssText =
      "padding: 12px 20px; margin-bottom: 20px; border-radius: 8px; font-weight: 500; text-align: center; background-color: #d4edda; color: #155724; border: 1px solid #c3e6cb;";
  } else {
    msgDiv.style.cssText =
      "padding: 12px 20px; margin-bottom: 20px; border-radius: 8px; font-weight: 500; text-align: center; background-color: #f8d7da; color: #721c24; border: 1px solid #f5c6cb;";
  }
...
function handleImage(e) {
  // Image handler doesn't save anywhere
